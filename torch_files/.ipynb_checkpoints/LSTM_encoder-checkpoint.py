# Inspired and adapted from Laura Kulowski, https://github.com/lkulowski/LSTM_encoder_decoder
...
# Attention code from https://github.com/spro/practical-pytorch/blob/master/seq2seq-translation/seq2seq-translation.ipynb
...
class lstm_seq2seq(nn.Module):
    ...
    def predict(self, input_tensor, target_tensor):
        ...
        outputs = torch.zeros(target_tensor.shape[0], target_tensor.shape[2])

        # decode input_tensor
        decoder_input = input_tensor[-1, :, :]
        decoder_hidden = encoder_hidden
        
        for t in range(target_tensor.shape[0]):
            decoder_output, decoder_hidden = self.decoder(decoder_input, decoder_hidden)
